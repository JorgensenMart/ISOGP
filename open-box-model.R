...
#################### Not needed ?
load("data/open-box/open-box-dist.RDa") # This loads in the pairwise distances (A)
A <- as.matrix(A)
#####################

load("data/open-box/open-box-init.RDa") # Loads in the init locations (initialized with isomap)
