...
source("scripts/model_protein.R") # This builds the model
...
# For plotting:
source("functions/plot_at_iteration_protein.R")
...
for(i in 1:iterations){
  ...
  if(i %% 1000 == 0){ # Save a model every 1000 iterations
    ...
    plot_at_iteration_protein(new_z, i)
    filename <- paste("results/protein/protein",i, sep = "")
