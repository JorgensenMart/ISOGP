...
source("scripts/open-box-model.R") # This builds the model
...
# For plotting:
source("functions/plot_at_iteration_ob.R")
...
for(i in 1:iterations){
  ...
  if(i %% 1000 == 0){ # Save a model every 1000 iterations
    ...
    plot_at_iteration_ob(new_z, i, "Open-Box")
    filename <- paste("results/open-box/iteration",i, sep = "")
