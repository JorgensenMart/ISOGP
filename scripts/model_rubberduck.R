...
#################### Not needed ?
load("data/rubberduck/dist_object.RDa") # This loads in the pairwise distances (A)
A <- as.matrix(A)
#####################

load("data/rubberduck/init_location.RDa") # Loads in the init locations (initialized with isomap)
