...
#################### Not needed ?
load("data/mnist/dist_object_invariance.RDa") # This loads in the pairwise distances (A)
...
driver <- censored_nakagami(model, z_batch, dist_batch, cut_off, number_of_interpolants = 10L, samples = 20L)
